 ...
 */
public class ExecOsCommandAtStart extends Thread implements LoadtestPluginInterface
{
	...
	public void execute(Object context)
	{
		...
		try
		{
			...
			t.join(120000);			// wait max 2 minutes, then continue with starting the load test
		}
		catch (Exception e)
		{
			logVector.log(e);
