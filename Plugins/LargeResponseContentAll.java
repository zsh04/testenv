 ...
 */
public class LargeResponseContentAll implements LoadtestPluginInterface
{
	...
	/**
	 * Initialize plug-in at start of each loop.
	 */
	...
	public static void main(String[] args)
	{
		try
		{
			...
			LargeResponseContentAll plugin = new LargeResponseContentAll();
