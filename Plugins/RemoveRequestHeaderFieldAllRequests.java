 ...
 */
public class RemoveRequestHeaderFieldAllRequests implements LoadtestPluginInterface
{
	...
	{
		return "Remove Request Header Field (all URLs)";
	}


	public String getPluginDescription()
	{
		return "Removes a Field from the HTTP Request Header of all HTTP Requests.\n\nIf the field name does not exists in some requests no action an no error will occur for such requests.\n\n";
	}
	...
	public static void main(String[] args)
	{
		try
		{
			...
			RemoveRequestHeaderFieldAllRequests plugin = new RemoveRequestHeaderFieldAllRequests();
